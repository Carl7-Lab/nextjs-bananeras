...
import InputFieldSpongeSelect from './InputFieldSpongeSelect';
...
const SpongeSelectBanContanier: React.FC<Props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default SpongeSelectBanContanier;
