...
import InputFieldProtectorSelect from './InputFieldProtectorSelect';
...
const ProtectorSelectBanContainer: React.FC<props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default ProtectorSelectBanContainer;
