...
import InputFieldPalletSelect from './InputFieldPalletSelect';
...
const PalletSelectBanContanier: React.FC<Props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default PalletSelectBanContanier;
