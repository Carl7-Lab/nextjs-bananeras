...
import InputFieldMiniPalletSelect from './InputFieldMiniPalletSelect';
...
const MiniPalletSelectBanContanier: React.FC<Props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default MiniPalletSelectBanContanier;
