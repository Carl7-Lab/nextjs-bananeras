...
import PadSelectBase from './PadSelectBase';

interface InputFieldPadSelectProps {
  name: string;
  label: string;
  placeholder: string;
  isBan?: {
...
const InputFieldPadSelect: React.FC<InputFieldPadSelectProps> = ({
  name,
  label,
  placeholder,
  isBan,
...
export default InputFieldPadSelect;
