...
import CoverSelectBase from './CoverSelectBase';

interface InputFieldCoverSelectProps {
  name: string;
  label: string;
  placeholder: string;
  isBan?: {
...
const InputFieldCoverSelect: React.FC<InputFieldCoverSelectProps> = ({
  name,
  label,
  placeholder,
  isBan,
...
export default InputFieldCoverSelect;
