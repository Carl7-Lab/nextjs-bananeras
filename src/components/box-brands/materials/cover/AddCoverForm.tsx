...
import { useCreateCover } from '@/hooks/box-brand/materials/cover/createCover';
...
const AddCoverForm = ({ onClose }: AddCoverFormProps): React.JSX.Element => {
  ...
  const addCover = async (
    ...
    createCover(
      { ...values },
      {
        ...
        onSuccess: () => {
          toast({
            title: 'Cubierta creada con Éxito',
            status: 'success',
            duration: 5000,
            isClosable: true,
          });
