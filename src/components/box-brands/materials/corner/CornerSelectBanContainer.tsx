...
import InputFieldCornerSelect from './InputFieldCornerSelect';
...
const CornerSelectBanContanier: React.FC<Props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default CornerSelectBanContanier;
