...
import InputFieldThermographSelect from './InputFieldThermographSelect';
...
const ThermographSelectBanContainer: React.FC<props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default ThermographSelectBanContainer;
