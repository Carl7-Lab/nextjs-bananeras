...
import InputFieldMettoLabelSelect from './InputFieldMettoLabelSelect';
...
const MettoLabelSelectBanContainer: React.FC<props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default MettoLabelSelectBanContainer;
