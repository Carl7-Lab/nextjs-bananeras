...
import InputFieldBlockingSheetSelect from './InputFieldBlockingSheetSelect';
...
const BlockingSheetSelectBanContainer: React.FC<props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default BlockingSheetSelectBanContainer;
